      ...
      {view === 'overview' ? (
        ...
        <section className="grid gap-6 2xl:grid-cols-[minmax(0,1.2fr)_minmax(430px,0.8fr)]">
          ...
          <aside className="self-start rounded-2xl border border-slate-700 bg-[#121a24] p-4 shadow-[0_18px_48px_rgba(0,0,0,0.2)] 2xl:sticky 2xl:top-6">
            ...
            <DocumentPreview type={documentType} reference={reference} customer={customer} booking={booking} issueDate={issueDate} dueDate={dueDate} items={items} subtotal={subtotal} vat={vat} total={total} notes={notes} />
          </aside>
        </section>
      )}
    </div>
